...
$sql = "SELECT * FROM product1 WHERE Category IN ('Ladies','Mens') AND Status = 'available'";
...
if ($result->num_rows > 0) {
    while ($product = $result->fetch_assoc()) {
        ...
        if (in_array($category, ['Ladies','Mens'])) {
    ...
    <header>
        <div class="navbar">
            ...
            <ul class="links">
                ...
                <li><a href="product-watch-collection.php">Shop</a></li>
