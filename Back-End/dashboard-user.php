...
<body>
  ...
  <div class="navbar">
    <button id="profileBtn" class="active"><i class="bi bi-person-circle"></i> My Profile</button>
    <button id="ordersBtn"><i class="bi bi-receipt"></i> My Orders</button>
  </div>
...
<div id="profileSection" class="section active">
  ...
  <form id="profileForm">
    <div class="form-group">
      ...
      <input type="text" id="userId" class="form-control" value="001" disabled> <!-- User ID -->
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="email" id="email" class="form-control" value="john@example.com" disabled>
    </div>
    <div class="form-group">
...
<div id="ordersSection" class="section">
  ...
  <table class="table table-bordered">
    ...
    <tbody id="ordersList">
      <!-- Orders will be dynamically inserted here based on User ID -->
    </tbody>
  </table>
</div>

  <script src="scriptUserOrderVal.js"></script>
</body>
</html>
